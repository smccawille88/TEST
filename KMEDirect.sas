...
ods html 
path="/home/smccawille1/Output"         
file="KMEDirect.html" image_dpi=300 style=journal;

ods graphics on / reset imagename="KMEDirect" outputfmt=png;
...
proc lifetest
   data = addeath
   plots = (survival(nocensor)); /*Nocensor hides teh central obs from plot*/
